        ...
        <div className="bg-gray-900">
            <div className='md:flex md:w-10/12 w-11/12 mx-auto py-10 text-white'>
                ...
                <div className='border-l-2 px-2'>
                    <p className='text-xl font-semibold border-2 p-4'>Visionary entrepreneur Elon Musk is the charismatic co-founder of PayPal (PYPL) and Tesla (TSLA), as well as the founder of SpaceX, Neuralink, and The Boring Company. He serves as CEO of Tesla and CEO/lead designer of SpaceX.</p>
                </div>
            </div>
        </div>
    );
