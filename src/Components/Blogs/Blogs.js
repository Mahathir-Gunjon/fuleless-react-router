...
const Blogs = () => {
    ...
    return (
        <div>
            <div className='bg-gradient-to-r from-gray-500 to-red-200 md:py-28 py-2'>
                <h1 className="md:text-6xl text-4xl md:my-7 my-3 text-center">Frequently Asked Question</h1>
                <div className="w-10/12 md:7/12 py-7 px-5 grid grid-cols-1 md:grid-cols-2 mx-auto shadow-2xl my-10 bg-white rounded-xl">
